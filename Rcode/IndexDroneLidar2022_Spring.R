...
BuildIndexFromPoints("", "", "", "D:/2022SpringData/DroneIndex2022_Spring.gpkg", projString = 26910, fullFileList = LASfiles, rebuild = TRUE)

# read and display along with units
index <- st_read("D:/2022SpringData/DroneIndex2022_Spring.gpkg")
...
st_write(index, "D:/2022SpringData/DroneIndex2022_Spring.shp")
